...
void DroneController::calcControl(TooN::Vector<4> new_err, TooN::Vector<4> d_error, double yaw)
{
	...
	// lastSentControl.yaw = 0.5*sin(1.256*i)+0.3*sin(6.28*i);
...
// -0.0000   -0.0000    2.8832    0.6539   -2.0297   -0.3160    0.0000    0.0000    0.0000   -0.0000   -0.0000   -0.0000   -0.0000    3.1623   -0.0000    0.0000
// -2.8438   -0.9238   -0.0000   -0.0000    0.0000    0.0000   -2.3328   -0.3159    0.0000   -0.0000   -0.0000   -0.0000   -3.1623    0.0000    0.0000   -0.0000
//  0.0000    0.0000   -0.0000   -0.0000    0.0000    0.0000    0.0000    0.0000    0.8579    0.3173    0.0000   -0.0000    0.0000   -0.0000    1.0000    0.0000
// -0.0000   -0.0000    0.0000    0.0000   -0.0000   -0.0000   -0.0000   -0.0000    0.0000    0.0000   -0.0088   -0.0027   -0.0000    0.0000    0.0000   -0.0100
...
//     vector_k11 = TooN::makeVector(0, 0, -1.58, -0.42, 0.80, 0.03, 0, 0, 0, 0, 0, 0, 0, 0.89, 0, 0); // fase5 - teste 2 - bom desempenho no teste do circulo
...
// 	// vector_k41 = 1000*vector_k41;

// 	// YAW
// 	if(vector_k41*states > 1 || vector_k41*states < -1)
// 	  new_int_err[3] = 0.6 * new_int_err[3];
...
// 	  new_int_err[2] = 0.6 * new_int_err[2];
